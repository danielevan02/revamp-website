...
export const Card = React.memo(
  ({
    ...
    <motion.div
      ...
      className={cn(
        "card rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden h-80 md:h-96 min-w-64 md:min-w-80 transition-all duration-300 ease-out snap-start",
